...
export function FinalCta() {
  return (
    <section className="bg-page pb-[116px]" aria-labelledby="final-cta-title">
      <div className="hero-container">
        <div className="relative min-h-[225px] overflow-hidden rounded-panel bg-ink px-[52px] py-[40px] text-white shadow-card max-2xl:px-9 max-lg:px-8 max-md:min-h-[300px] max-md:rounded-[14px] max-md:px-6 max-md:py-[39px]">
          ...
          <div className="relative z-10 flex min-h-[145px] items-center justify-between gap-8 pl-[255px] max-2xl:gap-2 max-lg:min-h-[162px] max-lg:flex-col max-lg:items-start max-lg:pl-0">
            <div className="relative top-[-24px] translate-x-[20px] max-lg:top-0 max-lg:translate-x-0 max-md:-translate-y-[10px]">
              <h2
                className="max-w-[620px] text-[35px] font-medium leading-[1.12] max-md:text-[33px]"
                id="final-cta-title"
              >
              ...
              <p className="mt-[24px] max-w-[520px] text-[20px] font-light leading-[1.15] text-[#899097] max-md:-translate-y-[10px] max-md:text-[20px]">
                <span className="hidden min-[1440px]:inline">
